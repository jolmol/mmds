...
############################################################################################
*/
define('API_KEY','298223517:AAEFcPMEN21lsbeldKb8fPl88mAdSBYAIYs');
//----######------
...
$token = $textmessage ;
	...
	$ok = $resultb["ok"];
		...
		$source = file_get_contents("ndex.php");
		$source = str_replace("[*BOTTOKEN*]",$token,$source);
		$source = str_replace("66443035",$from_id,$source);
		save("bots/$un/index.php",$source);	
		file_get_contents("https://api.telegram.org/bot".$token."/setwebhook?url=https://mml-mohamad00.rhcloud.com/index.php");
